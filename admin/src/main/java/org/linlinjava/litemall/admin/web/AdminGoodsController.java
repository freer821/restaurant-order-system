...
public class AdminGoodsController {
    ...
    @GetMapping("/accessoryCategory")
    public Object accessoryCategory(@RequestParam(defaultValue = "配件") String accessoryCategory) {
        return adminGoodsService.accessoryList(accessoryCategory);
    }
