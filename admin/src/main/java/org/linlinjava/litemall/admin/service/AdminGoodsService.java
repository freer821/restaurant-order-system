...
public class AdminGoodsService {
    ...
    public Object list2() {
        ...
        for (LitemallCategory l1 : l1CatList) {
            ...
            l1CatVo.setKeywords(l1.getKeywords());
            ...
            for (LitemallCategory l2 : l2CatList) {
                ...
                l2CatVo.setKeywords(l2.getKeywords());
    ...
    public Object accessoryList(String accessoryCategory) {
        List<LitemallCategory> l1CatList = categoryService.queryAccessoryCategory(accessoryCategory);
        List<CatVo> categoryList = new ArrayList<>(l1CatList.size());
        ...
        Map<String, Object> data = new HashMap<>();
        data.put("typeList", categoryList);
