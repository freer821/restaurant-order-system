...
public class LitemallGoodsExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected List<Criterion> accessoriesCriteria;
        ...
        protected GeneratedCriteria() {
            ...
            accessoriesCriteria = new ArrayList<Criterion>();
        }
        ...
        public List<Criterion> getAccessoriesCriteria() {
            return accessoriesCriteria;
        }

        protected void addAccessoriesCriterion(String condition, Object value, String property) {
            if (value == null) {
                throw new RuntimeException("Value for " + property + " cannot be null");
            }
            accessoriesCriteria.add(new Criterion(condition, value, "org.linlinjava.litemall.db.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }

        protected void addAccessoriesCriterion(String condition, String[] value1, String[] value2, String property) {
            if (value1 == null || value2 == null) {
                throw new RuntimeException("Between values for " + property + " cannot be null");
            }
            accessoriesCriteria.add(new Criterion(condition, value1, value2, "org.linlinjava.litemall.db.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        public List<Criterion> getAllCriteria() {
            if (allCriteria == null) {
                ...
                allCriteria.addAll(accessoriesCriteria);
            }
            return allCriteria;
        }
        ...
        public Criteria andAccessoriesEqualTo(String[] value) {
            addAccessoriesCriterion("accessories =", value, "accessories");
            return (Criteria) this;
        }
         ...
         * @mbg.generated
         */
        public Criteria andAccessoriesEqualToColumn(LitemallGoods.Column column) {
            addCriterion(new StringBuilder("accessories = ").append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
         ...
         * @mbg.generated
         */
        public Criteria andAccessoriesNotEqualToColumn(LitemallGoods.Column column) {
            addCriterion(new StringBuilder("accessories <> ").append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
         ...
         * @mbg.generated
         */
        public Criteria andAccessoriesGreaterThanColumn(LitemallGoods.Column column) {
            addCriterion(new StringBuilder("accessories > ").append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
         ...
         * @mbg.generated
         */
        public Criteria andAccessoriesGreaterThanOrEqualToColumn(LitemallGoods.Column column) {
            addCriterion(new StringBuilder("accessories >= ").append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
         ...
         * @mbg.generated
         */
        public Criteria andAccessoriesLessThanColumn(LitemallGoods.Column column) {
            addCriterion(new StringBuilder("accessories < ").append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
         ...
         * @mbg.generated
         */
        public Criteria andAccessoriesLessThanOrEqualToColumn(LitemallGoods.Column column) {
            addCriterion(new StringBuilder("accessories <= ").append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }

        public Criteria andAccessoriesLike(String[] value) {
            addAccessoriesCriterion("accessories like", value, "accessories");
            return (Criteria) this;
        }

        public Criteria andAccessoriesNotLike(String[] value) {
            addAccessoriesCriterion("accessories not like", value, "accessories");
            return (Criteria) this;
        }

        public Criteria andAccessoriesIn(List<String[]> values) {
            addAccessoriesCriterion("accessories in", values, "accessories");
            return (Criteria) this;
        }

        public Criteria andAccessoriesNotIn(List<String[]> values) {
            addAccessoriesCriterion("accessories not in", values, "accessories");
            return (Criteria) this;
        }

        public Criteria andAccessoriesBetween(String[] value1, String[] value2) {
            addAccessoriesCriterion("accessories between", value1, value2, "accessories");
            return (Criteria) this;
        }

        public Criteria andAccessoriesNotBetween(String[] value1, String[] value2) {
            addAccessoriesCriterion("accessories not between", value1, value2, "accessories");
            return (Criteria) this;
        }
    }
