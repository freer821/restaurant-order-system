...
public class LitemallCategoryService {
    ...
    public List<LitemallCategory> queryAccessoryCategory(String name) {
        LitemallCategoryExample example = new LitemallCategoryExample();
        example.or().andLevelEqualTo("L1").andNameEqualTo(name).andDeletedEqualTo(false);
        return categoryMapper.selectByExample(example);
    }

    public List<LitemallCategory> queryL1CategoryByKeyword(String keyword) {
        LitemallCategoryExample example = new LitemallCategoryExample();
        example.or().andLevelEqualTo("L1").andKeywordsEqualTo(keyword).andDeletedEqualTo(false);
        return categoryMapper.selectByExample(example);
    }
