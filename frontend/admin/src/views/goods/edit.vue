  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-form ref="goods" :rules="rules" :model="goods" label-width="150px">
        ...
        <el-form-item label="商品附属品">
          <el-select v-model="goods.accessories" multiple placeholder="请选择">
            <el-option
...
export default {
  ...
  data() {
    return {
      ...
      accessoryAdd: true,
      accessoryForm: { cate_id: '', single_selected: false },
      rules: {
    ...
    init: function() {
      ...
      listCatAndBrand().then(response => {
        ...
        this.categoryList.forEach(category => {
          if (category.keywords === 'accessory') {
            this.accessoryList = category.children
          }
        })
      })
    },
